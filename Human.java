...
public class Human extends Player {
	...
	System.out.println("Please place your battleship. This ship is five units long. \nChoose the orientation (horizontal or vertical) and the top left coordinate of the ship. \nThe coordinates range from A0 to J9. \nSeparate each entry by a space.");
	System.out.print("Orientation, letter of coordinate, number of coordinate: ");
	...
	System.out.println("Please place your cruiser. This ship is five units long. \nChoose the orientation (horizontal or vertical) and the top left coordinate of the ship. \nThe coordinates range from A0 to J9. \nSeparate each entry by a space.");
	System.out.print("Orientation, letter of coordinate, number of coordinate: ");
	...
	System.out.println("Please place your submarine. This ship is five units long. \nChoose the orientation (horizontal or vertical) and the top left coordinate of the ship. \nThe coordinates range from A0 to J9. \nSeparate each entry by a space.");
	System.out.print("Orientation, letter of coordinate, number of coordinate: ");
	...
	System.out.println("Please place your destroyer. This ship is five units long. \nChoose the orientation (horizontal or vertical) and the top left coordinate of the ship. \nThe coordinates range from A0 to J9. \nSeparate each entry by a space.");
	System.out.print("Orientation, letter of coordinate, number of coordinate: ");
