...
public class Human extends Player {
    ...
    public static void setupForFirstHuman(){
	System.out.println("\nFor each ship select the orientation(h for horizontal, v for vertical) and the top left coordinate of the ship. \nThe coordinates range from A0 to J9.\nSelect the letter(it must be uppercase) and the number and separate all entries with a space. \ni.e. h F 7");
    ...
    public static void setupForSecondHuman(){
	System.out.println("\nFor each ship select the orientation(h for horizontal, v for vertical) and the top left coordinate of the ship. \nThe coordinates range from A0 to J9.\nSelect the letter(it must be uppercase) and the number and separate all entries with a space. \ni.e. h F 7");
	...
	System.out.println("It's your turn, Player 1. Make your move... \nWhere would you like to attack?");
	attackLetter = in.next();
	attackNum = in.nextInt();
	hit1(human2, otherOceanGrid, attackLetter, attackNum);
	...
	System.out.println("It's your turn, Player 2. Make your move... \nWhere would you like to attack?");
	attackLetter = in.next();
	attackNum = in.nextInt();
	hit2(human1, yourOceanGrid, attackLetter, attackNum);
